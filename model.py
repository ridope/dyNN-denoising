...
class Decoder(nn.Module):
    def __init__(self, num_features=363, decoder_width = 1.0):
        ...
        #self.up6 = UpSample(skip_input=features//32 , output_features=128) #test
        self.conv3 = nn.Conv2d(features//32, 3, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, features):
        ...
        # Usar dimensoes da imagem de input (teste)
        x_d6 =  F.interpolate(x_d5, size=[321, 481], mode='bilinear', align_corners=True)
        #print(x_d6.shape)
        #x_d6 = self.up6(x_d5, x_block0)
        #print(x_d5.shape, x_block0.shape)
